  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-8 text-sm text-purple-200/80 leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-white">6. Reservas</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-white">6b. Cancelaciones</h2>
          <p>
            Al cancelar una reserva, el cliente debe seleccionar un motivo. Esta información
            se comparte con el profesional de forma agregada (sin datos personales identificables)
            para ayudarle a mejorar sus servicios. Los motivos incluyen: cambio de horario,
            problemas personales, enfermedad, pérdida de interés, precio, u otros.
          </p>
        </section>
